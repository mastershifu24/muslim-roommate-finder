...
US_MAJOR_CITIES = [
    # Top 100 cities by population - focusing on major metropolitan areas
    "New York", "Los Angeles", "Chicago", "Houston", "Phoenix", "Philadelphia", 
    "San Antonio", "San Diego", "Dallas", "San Jose", "Austin", "Jacksonville",
    "Fort Worth", "Columbus", "Charleston", "Charlotte", "San Francisco", "Indianapolis", "Seattle",
    ...
    "Virginia Beach", "Minneapolis", "Tampa", "Oakland", "New Orleans", "Wichita",
    "Arlington", "Cleveland", "Bakersfield", "Honolulu", "Anaheim", "Santa Ana",
...
class Profile(models.Model):
    ...
    profile_photo = models.ImageField(
        ...
        null=True, blank=True  # Allow null for existing profiles, but we'll enforce in forms
    )
...
class Room(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=0, verbose_name="Monthly Rent")  # Remove cents
